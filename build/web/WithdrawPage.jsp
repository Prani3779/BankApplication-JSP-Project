...
<html>
    ...
    <body>
        <table style="height: 100%; width: 100%">
            <tr>
                <td align="center">
                    <form action="WithdrawPage.jsp" method="Post">
                        <table class="table-condensed" style="border-style: double; border-width: 5px; border-color: green">
                            <tr>
                                <td colspan="2">
                                    <label class="form-control btn btn-success">Withdraw Transaction Form</label>
                                </td>
                            </tr>
                            <tr>
                                                        ...
                                                        if(Validator.isDouble(request.getParameter("txt3")))
                                                        {
                                                            ...
                                                            if(amt>0.0)
                                                            {
                                                                ...
                                                                if(rs.next())
                                                                {
                                                                    ...
                                                                    double amount=Double.valueOf(request.getParameter("txt3"));
                                                                    if(amount<=currentBalance)
                                                                    {
                                                                        int tid=new Random().nextInt(1000000000);
                                                                        ps=connection.prepareStatement("insert into withdraw values(?,?,?,?)");
                                                                        ps.setInt(1, tid);
                                                                    ...
                                                                    {
                                                                        out.println("Insuffiecient Balance");
                                                                    }
                                                                }
                                                                else
                                                                {
